...
```text
https://zhangleo-1983.github.io/ai-infrastructure-books/
```

当前由公开 GitHub 仓库的 `main` 分支通过 GitHub Pages 发布。自定义域名以及迁移到
Cloudflare Pages 或 Vercel 的工作暂缓，待系列内容进一步稳定后再统一处理。
...
整册打印：两册均已完成
公开 RC 部署：已通过 GitHub Pages 上线；自定义域名与托管迁移暂缓
```
